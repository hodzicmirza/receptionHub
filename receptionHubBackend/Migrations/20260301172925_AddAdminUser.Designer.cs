...
namespace receptionHubBackend.Migrations
{
    ...
    [Migration("20260301172925_AddAdminUser")]
            ...
            modelBuilder.Entity("receptionHubBackend.Models.Recepcioner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdRecepcionera = 1,
                            Aktivan = true,
                            DatumKreiranjaRacuna = new DateTime(2026, 3, 1, 17, 29, 24, 702, DateTimeKind.Utc).AddTicks(3284),
                            Email = "mhodzic6@etf.unsa.ba",
                            Ime = "Mirza",
                            KorisnickoIme = "mirzah",
                            LozinkaHash = "AQAAAAIAAYagAAAAEG855xKLPevH43KTI26jqvHcnP+W2xW1aEhcN6V9s5rbRrxZYvVeEhDY1WFlkPVOvA==",
                            Napomena = "Sistemski admin",
                            Pozicija = 1,
                            Prezime = "hodzic"
                        });
                });
            ...
            modelBuilder.Entity("receptionHubBackend.Models.Rezervacija", b =>
                {
                    ...
                    b.Property<int?>("RecepcionerIdRecepcionera")
                        .HasColumnType("integer");

                    b.Property<int>("SobaId")
                        .HasColumnType("integer");

                    b.Property<int?>("SobaIdSobe")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecepcionerIdRecepcionera");

                    b.HasIndex("SobaId")
                        .HasDatabaseName("IX_Rezervacija_SobaId");

                    b.HasIndex("SobaIdSobe");
            ...
            modelBuilder.Entity("receptionHubBackend.Models.Rezervacija", b =>
                {
                    ...
                    b.HasOne("receptionHubBackend.Models.Recepcioner", null)
                        .WithMany("Rezervacije")
                        .HasForeignKey("RecepcionerIdRecepcionera");
                    ...
                    b.HasOne("receptionHubBackend.Models.Soba", null)
                        .WithMany("Rezervacije")
                        .HasForeignKey("SobaIdSobe");
